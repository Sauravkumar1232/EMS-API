...
//        });
    ...
    public ResponseDto<String> update(EmployeDto dto) {
        ResponseDto<String> responseDto = new ResponseDto<>();
        Optional<Employe> employeOptional=employeeRepository.findById(dto.getId());
...
//        Optional<Employe> employeOptional = employeeRepository.deleteById(id);  permanent delete row
        if(Objects.nonNull(employeOptional)) {
